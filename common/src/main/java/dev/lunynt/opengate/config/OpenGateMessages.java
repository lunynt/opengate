...
public final class OpenGateMessages {
    private static final String DEFAULTS = """
            ...
            premium-login: '&8[&fᴏᴘᴇɴɢᴀᴛᴇ&8] &a✓ &7ʟᴏɢɢᴇᴅ ɪɴ ᴡɪᴛʜ &fᴘʀᴇᴍɪᴜᴍ'
            geyser-login: '&8[&fᴏᴘᴇɴɢᴀᴛᴇ&8] &a✓ &7ʟᴏɢɢᴇᴅ ɪɴ ᴡɪᴛʜ &fɢᴇʏꜱᴇʀ'
            prompt-title: '&f&lᴏᴘᴇɴɢᴀᴛᴇ'
            prompt-subtitle-login: '&7ʟᴏɢ ɪɴ ᴡɪᴛʜ &f/login <password>'
            prompt-subtitle-register: '&7ʀᴇɢɪꜱᴛᴇʀ ᴡɪᴛʜ &f/register'
            prompt-subtitle-totp: '&7ᴇɴᴛᴇʀ ʏᴏᴜʀ &f2ꜰᴀ ᴄᴏᴅᴇ'
            login-title: '&a&l✓ ʟᴏɢɢᴇᴅ ɪɴ'
            login-subtitle-premium: '&7ᴘʀᴇᴍɪᴜᴍ'
            login-subtitle-geyser: '&7ɢᴇʏꜱᴇʀ'
            login-subtitle-session: '&7ꜱᴇꜱꜱɪᴏɴ ʀᴇꜱᴛᴏʀᴇᴅ'
            login-subtitle-password: '&7ᴘᴀꜱꜱᴡᴏʀᴅ'
            login-subtitle-registration: '&7ᴀᴄᴄᴏᴜɴᴛ ᴄʀᴇᴀᴛᴇᴅ'
            login-subtitle-totp: '&7ᴛᴡᴏ-ꜰᴀᴄᴛᴏʀ'
            ...
            lobby-missing: '&8[&fᴏᴘᴇɴɢᴀᴛᴇ&8] &c✕ &7ɴᴏ ʟᴏʙʙʏ ꜱᴇʀᴠᴇʀ ɪꜱ ᴀᴠᴀɪʟᴀʙʟᴇ'
